...
if(isset($_POST['order'])){
   ...
   $address = 'flat no. '. $_POST['flat'] .', '. $_POST['street'] .', '. $_POST['state'] .', '. $_POST['city'] .', '. $_POST['pin_code'];
...
<section class="checkout-orders">
   ...
   <h3>your orders</h3>
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>City :</span>
            <input type="text" name="city" placeholder="e.g. panadura " class="box" maxlength="50" required>
         </div>
         <div class="inputBox">
            <span>State :</span>
