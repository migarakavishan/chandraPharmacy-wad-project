      ...
      <div class="box-container">
         ...
         ?>
               <form action="" method="post" class="box">
                  ...
                  <a href="quick_view.php?pid=<?= $fetch_cart['pid']; ?>" class="fas fa-eye"><span class="material-symbols-outlined">
                        visibility
                     </span></a>
                  ...
                  <div class="flex">
                     ...
                     <button type="submit" class="fas fa-edit" name="update_qty"><span class="material-symbols-outlined">
                           edit
                        </span></button>
                  </div>
